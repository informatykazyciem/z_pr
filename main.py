...
async def root():
    return {
        "Jeśli chcesz sprawdzić czy liczba jest pierwsza należy wpisać np. /prime/7 "
        ...
        "by odwrócić kolory obrazka - invert/image.jpg lub http://127.0.0.1:8000/picture/invert/image.jpg "
    }
